...
$EndDescr
$Comp
L Battery_Management:BQ27441DRZR-G1A U8
U 1 1 5BB27F17
P 5900 2650
F 0 "U8" H 5900 3317 50  0000 C CNN
F 1 "BQ27441DRZR-G1A" H 5900 3226 50  0000 C CNN
F 2 "Package_SON:Texas_S-PDSO-N12" H 6150 2100 50  0001 L CNN
F 3 "http://www.ti.com/lit/ds/symlink/bq27441-g1.pdf" H 6100 2850 50  0001 C CNN
F 4 "BQ27441DRZR-G1A" H 5900 2650 50  0001 C CNN "Manufacturer Part Number"
	1    5900 2650
	1    0    0    -1  
$EndComp
Wire Wire Line
...
F 0 "#PWR0155" H 5900 3350 50  0001 C CNN
...
F 0 "#PWR0156" H 5050 3350 50  0001 C CNN
...
Wire Wire Line
	5050 3600 5050 3450
Text HLabel 5050 2450 0    50   BiDi ~ 0
SDA
...
F 0 "C27" H 6950 2500 50  0000 L CNN
F 1 "0.47uF" H 6900 2400 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.05x0.95mm_HandSolder" H 6800 2500 50  0001 C CNN
F 3 "~" H 6800 2500 50  0001 C CNN
F 4 "885012206024" H 6800 2500 50  0001 C CNN "Manufacturer Part Number"
	1    6800 2500
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "#PWR0157" H 6800 2350 50  0001 C CNN
...
F 0 "R17" V 4550 4000 50  0000 L CNN
F 1 "10m" V 4350 4000 50  0000 L CNN
F 2 "Resistor_SMD:R_2512_6332Metric_Pad1.52x3.35mm_HandSolder" V 4380 4000 50  0001 C CNN
F 3 "~" H 4450 4000 50  0001 C CNN
F 4 "1%" V 4450 4000 50  0000 C CNN "Tolerance"
F 5 "KRL3264-C-R010-F-T1" V 4450 4000 50  0001 C CNN "Manufacturer Part Number"
	1    4450 4000
	0    1    1    0   
$EndComp
Wire Wire Line
...
Text HLabel 5350 4000 2    50   BiDi ~ 0
SYS
$Comp
...
F 0 "#PWR10" H 7300 2500 50  0001 C CNN
F 1 "+3V3_Internal" H 7285 2275 50  0000 C CNN
...
F 0 "R21" V 7400 2400 50  0000 L CNN
F 1 "10k" V 7200 2400 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.05x0.95mm_HandSolder" V 7230 2400 50  0001 C CNN
F 3 "~" H 7300 2400 50  0001 C CNN
F 4 "RC0603JR-0710KL" V 7300 2400 50  0001 C CNN "Manufacturer Part Number"
	1    7300 2400
	1    0    0    -1  
$EndComp
$Comp
...
F 0 "R20" V 5150 3300 50  0000 L CNN
F 1 "10k" V 4950 3300 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.05x0.95mm_HandSolder" V 4980 3300 50  0001 C CNN
F 3 "~" H 5050 3300 50  0001 C CNN
F 4 "RC0603JR-0710KL" V 5050 3300 50  0001 C CNN "Manufacturer Part Number"
	1    5050 3300
	1    0    0    -1  
$EndComp
Wire Wire Line
...
U 1 1 5CE8DBB7
P 6200 5500
AR Path="/5BB6C3A1/5CE8DBB7" Ref="U?"  Part="1" 
AR Path="/5BB6C83B/5CE8DBB7" Ref="U?"  Part="1" 
AR Path="/5BC14C3C/5CE8DBB7" Ref="U?"  Part="1" 
AR Path="/5BC28DAC/5CE8DBB7" Ref="U9"  Part="1" 
F 0 "U9" H 6250 5300 50  0000 L CNN
F 1 "MCP6001-OT" H 6250 5200 50  0000 L CNN
F 2 "Package_TO_SOT_SMD:SOT-23-5" H 6100 5300 50  0001 L CNN
F 3 "http://ww1.microchip.com/downloads/en/DeviceDoc/21733j.pdf" H 6200 5700 50  0001 C CNN
F 4 "MCP6001T-I/OT" H 6200 5500 50  0001 C CNN "Manufacturer Part Number"
	1    6200 5500
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5CE8DBBD
P 6100 4700
AR Path="/5BB6C3A1/5CE8DBBD" Ref="#PWR?"  Part="1" 
AR Path="/5BB6C83B/5CE8DBBD" Ref="#PWR?"  Part="1" 
AR Path="/5BC14C3C/5CE8DBBD" Ref="#PWR?"  Part="1" 
AR Path="/5BC28DAC/5CE8DBBD" Ref="#PWR20"  Part="1" 
F 0 "#PWR20" H 6100 5100 50  0001 C CNN
F 1 "+3V3_Internal" H 6085 4873 50  0000 C CNN
...
U 1 1 5CE8DBC7
P 6100 5800
AR Path="/5BB6C3A1/5CE8DBC7" Ref="#PWR?"  Part="1" 
AR Path="/5BB6C83B/5CE8DBC7" Ref="#PWR?"  Part="1" 
AR Path="/5BC14C3C/5CE8DBC7" Ref="#PWR?"  Part="1" 
AR Path="/5BC28DAC/5CE8DBC7" Ref="#PWR021"  Part="1" 
...
U 1 1 5CE8DBD0
P 6300 5000
AR Path="/5BB6C3A1/5CE8DBD0" Ref="#PWR?"  Part="1" 
AR Path="/5BB6C83B/5CE8DBD0" Ref="#PWR?"  Part="1" 
AR Path="/5BC14C3C/5CE8DBD0" Ref="#PWR?"  Part="1" 
AR Path="/5BC28DAC/5CE8DBD0" Ref="#PWR022"  Part="1" 
...
U 1 1 5CE8DBD6
P 6650 5000
AR Path="/5BB6C3A1/5CE8DBD6" Ref="#PWR?"  Part="1" 
AR Path="/5BB6C83B/5CE8DBD6" Ref="#PWR?"  Part="1" 
AR Path="/5BC14C3C/5CE8DBD6" Ref="#PWR?"  Part="1" 
AR Path="/5BC28DAC/5CE8DBD6" Ref="#PWR023"  Part="1" 
F 0 "#PWR023" H 6650 4750 50  0001 C CNN
...
U 1 1 5CE8DBE1
P 6300 4900
AR Path="/5BB122CA/5CE8DBE1" Ref="C?"  Part="1" 
AR Path="/5BB12371/5CE8DBE1" Ref="C?"  Part="1" 
AR Path="/5BB123AC/5CE8DBE1" Ref="C?"  Part="1" 
AR Path="/5BB6C3A1/5CE8DBE1" Ref="C?"  Part="1" 
AR Path="/5BC13C37/5CE8DBE1" Ref="C?"  Part="1" 
AR Path="/5BC14C3C/5CE8DBE1" Ref="C?"  Part="1" 
AR Path="/5BC28DAC/5CE8DBE1" Ref="C23"  Part="1" 
F 0 "C23" H 6208 4854 50  0000 R CNN
F 1 "1uF" H 6208 4945 50  0000 R CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.05x0.95mm_HandSolder" H 6300 4900 50  0001 C CNN
F 3 "~" H 6300 4900 50  0001 C CNN
F 4 "10V" H 6300 4900 50  0001 C CNN "Voltage"
F 5 "LMK107B7105MA-T" H 6300 4900 50  0001 C CNN "Manufacturer Part Number"
	1    6300 4900
	-1   0    0    1   
$EndComp
Wire Wire Line
...
U 1 1 5CE8DBEC
P 6650 4900
AR Path="/5BB122CA/5CE8DBEC" Ref="C?"  Part="1" 
AR Path="/5BB12371/5CE8DBEC" Ref="C?"  Part="1" 
AR Path="/5BB123AC/5CE8DBEC" Ref="C?"  Part="1" 
AR Path="/5BB6C3A1/5CE8DBEC" Ref="C?"  Part="1" 
AR Path="/5BB6C83B/5CE8DBEC" Ref="C?"  Part="1" 
AR Path="/5BC14C3C/5CE8DBEC" Ref="C?"  Part="1" 
AR Path="/5CE8DBEC" Ref="C?"  Part="1" 
AR Path="/5BC13C37/5CE8DBEC" Ref="C?"  Part="1" 
AR Path="/5BC28DAC/5CE8DBEC" Ref="C24"  Part="1" 
F 0 "C24" H 6558 4854 50  0000 R CNN
F 1 "100nF" H 6558 4945 50  0000 R CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.05x0.95mm_HandSolder" H 6650 4900 50  0001 C CNN
F 3 "~" H 6650 4900 50  0001 C CNN
F 4 "10V" H 6650 4900 50  0001 C CNN "Voltage"
F 5 "EMK107B7104KAHT" H 6650 4900 50  0001 C CNN "Manufacturer Part Number"
	1    6650 4900
	-1   0    0    1   
$EndComp
Wire Wire Line
	5550 5600 5550 6050
$Comp
L AXTEC_IC:INA216A4RSWR U7
U 1 1 5CE9CD26
P 4200 4700
F 0 "U7" V 4259 4779 50  0000 L CNN
F 1 "INA216A4RSWR" V 4350 4779 50  0000 L CNN
F 2 "Package_DFN_QFN:UQFN-10_1.4x1.8mm_P0.4mm" H 4200 4950 50  0001 C CNN
F 3 "" H 4200 4950 50  0001 C CNN
F 4 "INA216A4RSWR" V 4441 4779 50  0000 L CNN "Manufacturer Part Number"
	1    4200 4700
	0    -1   1    0   
$EndComp
Wire Wire Line
...
U 1 1 5CEA29A9
P 4850 4950
AR Path="/5BA1A7F9/5CEA29A9" Ref="#PWR?"  Part="1" 
AR Path="/5BA1A77A/5CEA29A9" Ref="#PWR?"  Part="1" 
AR Path="/5BB1631B/5CEA29A9" Ref="#PWR?"  Part="1" 
AR Path="/5BC28DAC/5CEA29A9" Ref="#PWR018"  Part="1" 
F 0 "#PWR018" H 4850 4700 50  0001 C CNN
...
U 1 1 5CEAC821
P 5000 5700
AR Path="/5BB6C3A1/5CEAC821" Ref="#PWR?"  Part="1" 
AR Path="/5BB6C83B/5CEAC821" Ref="#PWR?"  Part="1" 
AR Path="/5BC14C3C/5CEAC821" Ref="#PWR?"  Part="1" 
AR Path="/5BC28DAC/5CEAC821" Ref="#PWR019"  Part="1" 
...
U 1 1 5CEAC829
P 5000 5600
AR Path="/5BB122CA/5CEAC829" Ref="C?"  Part="1" 
AR Path="/5BB12371/5CEAC829" Ref="C?"  Part="1" 
AR Path="/5BB123AC/5CEAC829" Ref="C?"  Part="1" 
AR Path="/5BB6C3A1/5CEAC829" Ref="C?"  Part="1" 
AR Path="/5BB6C83B/5CEAC829" Ref="C?"  Part="1" 
AR Path="/5BC14C3C/5CEAC829" Ref="C?"  Part="1" 
AR Path="/5CEAC829" Ref="C?"  Part="1" 
AR Path="/5BC13C37/5CEAC829" Ref="C?"  Part="1" 
AR Path="/5BC28DAC/5CEAC829" Ref="C22"  Part="1" 
F 0 "C22" H 4908 5554 50  0000 R CNN
F 1 "100nF" H 4908 5645 50  0000 R CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.05x0.95mm_HandSolder" H 5000 5600 50  0001 C CNN
F 3 "~" H 5000 5600 50  0001 C CNN
F 4 "10V" H 5000 5600 50  0001 C CNN "Voltage"
F 5 "EMK107B7104KAHT" H 5000 5600 50  0001 C CNN "Manufacturer Part Number"
	1    5000 5600
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 5CEAECF7
P 4700 5400
AR Path="/5BA17F9C/5CEAECF7" Ref="R?"  Part="1" 
AR Path="/5BA1A7F9/5CEAECF7" Ref="R?"  Part="1" 
AR Path="/5BA1A77A/5CEAECF7" Ref="R?"  Part="1" 
AR Path="/5CEAECF7" Ref="R?"  Part="1" 
AR Path="/5BB1631B/5CEAECF7" Ref="R?"  Part="1" 
AR Path="/5BC28DAC/5CEAECF7" Ref="R12"  Part="1" 
F 0 "R12" V 4800 5350 50  0000 L CNN
F 1 "1k" V 4600 5350 50  0000 L CNN
F 2 "Capacitor_SMD:C_0603_1608Metric_Pad1.05x0.95mm_HandSolder" V 4630 5400 50  0001 C CNN
F 3 "~" H 4700 5400 50  0001 C CNN
F 4 "RC0603JR-071KL" V 4700 5400 50  0001 C CNN "Manufacturer Part Number"
	1    4700 5400
	0    1    1    0   
$EndComp
Wire Wire Line
